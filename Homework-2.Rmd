...
\end{bmatrix}
$$
Therefore, the principal component directions will be the columns of $V$, the principal components will be the inner products $z_j = \langle x_i, v_j\rangle$, the columns of: 
...
\end{bmatrix}
$$
 The "loadings" of the first principal component are the first column of the matrix $V$, 
