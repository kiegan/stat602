...
\end{bmatrix}
$$
Thus, the basis for $C(X)$ will be the columns of $U$.  


\textbf{Part b}  

We can find the eigen (spectral) decomposition of $X'X$ by calculating the eigen values, $D^2$, and the eigenvectors, which will be the columns of $V$:  
